...
LAYERS = {'water': 0, 'ground': 1, 'soil': 2, 'soil_water': 3, 'rain_floor': 4, 'house_bottom': 5, 'ground_plant': 6,
          'main': 7, 'fruit': 8, 'rain_drops': 9}
...
SELL_PRICES = {'wood': 4, 'apple': 2, 'corn': 10, 'tomato': 20}

BUY_PRICES = {'corn': 4, 'tomato': 5}
